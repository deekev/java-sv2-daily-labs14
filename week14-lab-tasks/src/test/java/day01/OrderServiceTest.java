...
class OrderServiceTest {
    ...
    void testGetOrderByStatus() {
        ...
        List<Order> result = orderService.getOrderByStatus("pending");
    ...
    @Test
    void testIsOrderWithLessProduct() {

        assertTrue(orderService.isOrderWithLessProduct(4));
        assertFalse(orderService.isOrderWithLessProduct(3));
    }

    @Test
    void testGetOrderWithMostProduct() {
    ...
    @Test
    void testGetOrdersWithCategoryOfProduct() {

        List<Order> result = orderService.getOrdersWithCategoryOfProduct("Book");
